...
const ayushMehta = {
  ...
  stack: [
    "C++", "Kotlin", "JavaScript", "Python", "C",
    "React.js", "Node.js", "Express.js",
    "MySQL", "MongoDB",
    "Jetpack Compose", "Android Studio"
  ],
  launchedProjects: [
    "Laughter Latte — Modern Coffee Ordering App",
    "Personal Portfolio Website"
  ],
  certifications: [
    "AWS S3 Basics (2026)",
    "Coding Competition — GNIOT & CSE Tech Club (2025)",
    "Web Development by MyCAPTAIN (2025)",
    "Coding Competition by ACM (2025)",
    "Science Battle — GNIOT (2024, 2nd Place)"
  ],
  status: "Solved 200+ DSA problems on LeetCode",
  openTo: [
...
🔗 [Code](https://github.com/mehtaayushkumar007/portfolio_ayush_mehta)

#### ☕ Laughter Latte — Modern Coffee Ordering App

An Android coffee ordering app with an intuitive UI, category-based browsing, search functionality, and responsive layouts, built using MVVM architecture.
...
![Languages](https://skillicons.dev/icons?i=cpp,kotlin,js,python,c)
...
<img src="https://github-profile-trophy.vercel.app/?username=mehtaayushkumar007&theme=nord&no-frame=true&no-bg=true&margin-w=15&column=7" width="100%"/>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ayush-mehta-gniot/)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/mehtaayushkumar007)
